...
- Increased `django-x509 <https://github.com/edge-servers/django-x509#django-x509>`_
  version to 0.9.2
- Increased `django-flat-json-widget <https://github.com/edge-servers/django-flat-json-widget#django-flat-json-widget>`_
  version to 0.1.2
...
- [change] Increased minimum `netjsonconfig <https://github.com/edge-servers/netjsonconfig>`_ version to 0.8.0
